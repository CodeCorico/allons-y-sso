...
SAML.prototype.generateServiceProviderMetadata = function( decryptionCert ) {
  var metadata = {
    'EntityDescriptor' : {
      ...
      'SPSSODescriptor' : {
        ...
        '@AuthnRequestsSigned': this.options.authnRequestsSigned || false,
        '@WantAssertionsSigned': this.options.wantAssertionsSigned || false
      },
    }
  };
  ...
  if (this.options.logoutCallbackUrl) {
    metadata.EntityDescriptor.SPSSODescriptor.SingleLogoutService = {
      ...
      '@ResponseLocation': this.options.logoutCallbackUrl
    };
  }
